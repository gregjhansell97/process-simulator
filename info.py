class Info(object):
    ...
    def __str__(self):
    	...
    	toprint += "-- average CPU burst time: " + "%.2f"%(round(self.burst_time/self.num_processes, 2)) + " ms\n"
    	toprint += "-- average wait time: " + "%.2f"%(round(self.wait_time/self.num_processes, 2)) + " ms\n"
    	toprint += "-- average turnaround time: " + "%.2f"%(round(self.turnaround_time/self.num_processes, 2)) + " ms\n"
